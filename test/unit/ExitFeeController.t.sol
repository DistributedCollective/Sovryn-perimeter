...
contract ExitFeeControllerTest is Test {
    ...
    bytes32 constant SURFACE = keccak256("PERIMETER:PERIMETER_SURFACE_LENDING_LENDER_WITHDRAW");
    bytes32 constant SURFACE_OTHER = keccak256("PERIMETER:PERIMETER_SURFACE_ZERO_WITHDRAW_COLL");
