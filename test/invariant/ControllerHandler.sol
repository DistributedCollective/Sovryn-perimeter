...
contract ControllerHandler {
    ...
    constructor(ExitFeeController controller_) {
        ...
        _surfaces[0] = keccak256("PERIMETER:PERIMETER_SURFACE_LENDING_LENDER_WITHDRAW");
        _surfaces[1] = keccak256("PERIMETER:PERIMETER_SURFACE_LENDING_BORROWER_WITHDRAW");
        _surfaces[2] = keccak256("PERIMETER:PERIMETER_SURFACE_ZERO_WITHDRAW_COLL");
        _surfaces[3] = keccak256("PERIMETER:PERIMETER_SURFACE_AMM_REMOVE_LIQUIDITY");
